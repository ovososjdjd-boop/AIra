...
## T. Речь, синестезия, вспоминание по крючку (запрос заказчика, BRAIN_CUES.md)

**Речевые потоки:**
- **Hickok & Poeppel, "The cortical organization of speech processing", Nat. Rev. Neurosci. 2007** — [semanticscholar.org](https://www.semanticscholar.org/paper/The-cortical-organization-of-speech-processing-Hickok-Poeppel/e56cd8c476716777cdb89db68a0658d26c646e5d) — двухпоточная модель: вентральный (понимание, билатерально), дорсальный (звук→артикуляция, левая доминантность, Spt).
- **Hickok, "The dual stream model of speech and language processing", Handbook of Clinical Neurology 2022** — [pubmed 35078610](https://www.ncbi.nlm.nih.gov/pubmed/35078610) — современное изложение; клиническая двойная диссоциация афазий (Р-1..Р-3).

**Синестезия:**
- **Ramachandran & Hubbard, "Synaesthesia — a window into perception, thought and language", JCS 2001** — [PDF](https://www.sfu.ca/~kathleea/colour/docs/Ram&Hub_2001.pdf) — кросс-активация: избыточная проводка/дефект обрезки между картами; связь с метафорой и креативностью (С-1..С-4).
- **Обзор (Brang+ / Frontiers 2013)** — [frontiersin.org/articles/10.3389/fnhum.2013.00563](https://www.frontiersin.org/articles/10.3389/fnhum.2013.00563/full) — кросс-активация vs расторможенная обратная связь; DTI Rouw–Scholte 2007 (гиперконнективность подтверждена); мост Хебба «динамика→структура».
- **Neufeld et al., "Disinhibited feedback as a cause of synesthesia", Neuropsychologia 2012** — [sciencedirect.com/science/article/abs/pii/S0028393212001029](https://www.sciencedirect.com/science/article/abs/pii/S0028393212001029) — усиленная связь теменного нексуса (IPC) с A1/V1: связи общие у всех, меняется вес — не топология (С-1б).

**Вспоминание по крючку (паттерн-достройка):**
- **Rolls, "Pattern separation, completion, and categorisation in the hippocampus and neocortex", Neurobiol. Learn. Mem. 2016** — [sciencedirect.com/science/article/abs/pii/S107474271500129X](https://www.sciencedirect.com/science/article/abs/pii/S107474271500129X) — DG ортогонализация, CA3 единый автоассоциатор, Hebb+LTD, разбавленная проводка для ёмкости (П-1..П-3).
- **Rolls, "A theory of hippocampal function: New developments", Prog. Neurobiol. 2024** — [sciencedirect.com/science/article/pii/S0301008224000728](https://www.sciencedirect.com/science/article/pii/S0301008224000728) — вход EC→CA3 как ассоциативный триггер; CA1 = сжатый код-указатель для обратной распаковки в кору (П-3..П-4).
- **Staresina & Wimber, "A Neural Chronometry of Memory Recall", TiCS 2019** — [cell.com](https://www.cell.com/trends/cognitive-science/fulltext/S1364-6613(19)30235-9) — хронометрия: крючок → достройка с ~500 мс → reinstatement до ~1,5 с; разворот потока (крючок прямым, память обратным); гейт фамильярности в MTL до достройки (П-4..П-5).
- **Классика (по данным обзоров выше):** Marr 1971 (автоассоциативная память); Treves & Rolls 1992/1994 (ёмкость CA3); Teyler & DiScenna 1986 (индексная теория: гиппокамп хранит указатель, не контент — П-6).
- **Современные автоассоциаторы для реализации (из кластеров A/O, добавить сюда перекрёстно):** Krotov & Hopfield 2016/DAM; Ramsauer et al., "Hopfield Networks Is All You Need", 2020 — [arxiv.org/abs/2008.02217](https://arxiv.org/abs/2008.02217) — непрерывные совр. сети Хопфилда = внимание; мостик стор↔трансформер для M3-гибрида.
